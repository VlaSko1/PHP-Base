...
// _log($params) - всякий раз при вызове будет записывать в файл log.log информацию о переменной $params
// _log($params, "primer"); - тоже что и выше, но файл будет новый с названием log_primer.log
// используется в качестве альтернативы var_dump, но удобен для ассинхронности
